...
## Corpus Check
- 263 files · ~230,288 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2764 nodes · 4716 edges · 165 communities (141 shown, 24 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 70 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eb487f0e`
...
- `CarbonBaseline` --references--> `ElementSnapshot`  [EXTRACTED]
  WebApp/src/setups/carbon-panel.ts → WebApp/src/sentinel-core/revision-diff.ts
- `Baseline` --references--> `ElementSnapshot`  [EXTRACTED]
  WebApp/src/setups/cost-panel.ts → WebApp/src/sentinel-core/revision-diff.ts
...
Cohesion: 0.13
Nodes (11): IDisposable, ElementSet, ExternalCommandData, Result, IReadOnlyList, Action, CancellationToken, HttpClient (+3 more)

### Community 1 - "SentinelAddin/UI"
Cohesion: 0.13
Nodes (31): defaultFactors, BoQ, pruned(), snapshotFromQuantities(), CarbonBaseline, carbonPanel(), esc(), fmtDate() (+23 more)

### Community 2 - "SentinelAddin/Engine"
Cohesion: 0.19
Nodes (11): BoundingBoxXYZ, BuiltInCategory, Document, double, Element, IEnumerable, List, XYZ (+3 more)
...
Cohesion: 0.06
Nodes (35): BcfIssue, Grade, HostCategory, HostId, HostName, LinkName, LocationText, OtherName (+27 more)
...
Cohesion: 0.11
Nodes (36): extractFacts(), quantityTakeoff(), CarbonReport, evaluateGate(), bdsRuleset, buildBoQ(), defaultRates, scan() (+28 more)

### Community 9 - "src/setups"
Cohesion: 0.33
Nodes (9): List, BcfComment, BcfComponent, BcfComponents, BcfHistory, BcfTopic, BcfViewpoint, PerspectiveCamera (+1 more)
...
Cohesion: 0.11
Nodes (34): Audit, Container, Folder, NEXT, State, STATE_COLOR, STATE_LABEL, STATES (+26 more)
...
Cohesion: 0.16
Nodes (9): FillPatternElement, OverrideGraphicSettings, SavedState, Document, ElementId, object, UIApplication, SavedState (+1 more)
...
Cohesion: 0.15
Nodes (25): attr(), collectNames(), extractAssets(), firstOf(), flatten(), MAINTAINABLE, toAsset(), assess() (+17 more)
...
Cohesion: 0.06
Nodes (60): bidTotal(), broadcast(), broadcastLocal(), CLASH_STATUSES, clashItems(), cldb, db, DEFAULT_CORS (+52 more)
...
Cohesion: 0.23
Nodes (9): ReconcileReport, ElementSet, ExternalCommandData, Result, ClashManagerCommand, MepVoidsCommand, RoiDashboardCommand, SanitizeFamilyCommand (+1 more)

### Community 29 - "SentinelAddin/Updaters"
Cohesion: 0.11
Nodes (21): Payload, DateTimeOffset, Guid, AuditEntry, ChangeRequest, RequestStatus, Dictionary, Document (+13 more)
...
Cohesion: 0.10
Nodes (18): Category, NewValue, OldValue, RequestedBy, When, EventArgs, RequestList, SubHeader (+10 more)
...
Cohesion: 0.16
Nodes (13): IExternalEventHandler, Inputs, List, MappingResult, double, UIApplication, GhostBuilderPlacementEvent, CancellationToken (+5 more)
...
Cohesion: 0.19
Nodes (12): Action, BuiltInCategory, Document, double, Element, List, string, XYZ (+4 more)
...
Cohesion: 0.24
Nodes (6): ClashRow, LiveInfo, BcfConfig, HttpClient, List, GovernedQuery

### Community 51 - "SentinelAddin"
Cohesion: 0.13
Nodes (15): 3d-tiles-renderer, lit, @sparkjsdev/spark, @thatopen-platform/fragments-beta, @thatopen/services, @thatopen/ui, three, dependencies (+7 more)
...
### Community 57 - "WebApp"
Cohesion: 0.07
Nodes (54): getAppManager(), setAppContext(), SERVICE_URL, firstWorld(), main(), tabbed(), BakeElement, Ruleset (+46 more)
...
Cohesion: 0.20
Nodes (6): Sentinel.Workflow, Sentinel.Engine, Sentinel.UI, Sentinel.Updaters, List, Settings
...
Cohesion: 0.04
Nodes (46): 1. Install the frontend components and UI library, 2. Overwrite main.ts with the fully-featured BIM boilerplate, 3. Restart the dev server, 🤖 Assistant, 🤖 Assistant, 🤖 Assistant, 🤖 Assistant, 🤖 Assistant (+38 more)
...
Cohesion: 0.15
Nodes (12): @types/three, typescript, vite, vitest, devDependencies, @types/three, typescript, vite (+4 more)
...
Cohesion: 0.18
Nodes (12): char, Document, double, ElementId, Guid, HashSet, IEnumerable, IList (+4 more)
...
Cohesion: 0.31
Nodes (6): RoiEntry, RoiSummary, double, List, object, RoiTracker
...
Cohesion: 0.07
Nodes (43): attr(), extractFromModel(), ExtractOptions, flattenParams(), TARGET_CATEGORIES, toFact(), escapeRegex(), make() (+35 more)
...
Cohesion: 0.28
Nodes (6): EvaluatedCheck, GATE_DEFS, GateCheck, GateMetrics, GateResult, Metric
...
Cohesion: 0.09
Nodes (40): buildCarbon(), CarbonFactor, CarbonFactors, CarbonLine, resolveFactor(), factors, ElementComponents, ElementGraph (+32 more)
...
### Community 124 - "Sentinel.Coordination"
Cohesion: 0.25
Nodes (3): Sentinel.Coordination, BcfIssuesCommand, BcfOp
...
### Community 133 - "LocalGhostBuilder"
Cohesion: 0.25
Nodes (5): CancellationToken, HttpClient, IEnumerable, string, LocalGhostBuilder
...
Cohesion: 0.33
Nodes (4): ElementSet, ExternalCommandData, Result, ClashRegisterCommand
...
### Community 141 - "GovernedQuery.cs"
Cohesion: 0.40
Nodes (5): double, int, string, ClashRow, LiveInfo
...
Cohesion: 0.40
Nodes (4): DateTimeOffset, Dictionary, RoiEntry, RoiSummary
...
Cohesion: 0.15
Nodes (9): Sentinel.Commands, ElementSet, ExternalCommandData, Result, ToggleAutoPublishCommand, ElementSet, ExternalCommandData, Result (+1 more)

### Community 159 - "guide-panel.ts"
Cohesion: 0.50
Nodes (3): STAGES, Topic, TOPICS

### Community 161 - "fragments-quantities.ts"
Cohesion: 0.16
Nodes (17): attr(), BoxLike, COSTABLE, fromModel(), num(), prefer(), QtoResult, readQto() (+9 more)
...
- **Why does `Sentinel.Engine` connect `sentinel-core/adapter` to `SentinelAddin/Standards`, `src/setups`, `src/setups`, `Window`, `package.json`, `SentinelAddin/Engine`, `.LoadEffective`, `ClashManager.cs`, `SentinelAddin/UI`, `src/setups`, `SentinelAddin/GhostBuilder`, `reality-capture/lib`, `SentinelAddin/Updaters`, `SentinelAddin`, `SentinelAddin/Standards`, `src/setups`, `SentinelAddin`, `.Read`, `Window`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `ok()` connect `src/sentinel-core` to `SentinelAddin/Workflow`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `evaluateGate()` connect `SentinelAddin/Workflow` to `.Execute`, `src/sentinel-core`, `WebApp`?**
