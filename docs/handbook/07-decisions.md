...
- **Built (2026-07-26):** `config/base-standard/` pack is now shipped with both rulesets; server-side IDS and naming ruleset custody via `SENTINEL_IDS` and `SENTINEL_NAMING_RULESET` env vars, with client fallback.
