...
| **F7** keystore crack · **F11** ACAO · **F12** transport · **F13/F14** hardening | ⏸ **Triaged** | Next-session work; see remediation order. Lower live risk now that F1/F2/F4 are closed and the bridge is loopback-bound. |
