...
| **F11** ACAO:* · **F12** transport (HTTPS) | ⏸ **Triaged** | Deferred — both need live testing (CORS could break SPA image loads; HTTPS is a hosting change). Lower live risk while the bridge is loopback-bound. |
